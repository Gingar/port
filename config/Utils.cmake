...
MACRO (OPTIONAL_FIND_PACKAGE _name )
	...
	IF(NOT DEFINED WITH_${_name_upper} )
		OPTION(WITH_${_name_upper} "Search for ${_name_upper} package" ON )
	ENDIF(NOT DEFINED WITH_${_name_upper} )
	
	SET(HAVE_${_name_upper} 0)
	if (WITH_${_name_upper})
		FIND_PACKAGE(${_name} ${ARGN})
		if(${_name_upper}_FOUND)
			SET(HAVE_${_name_upper} 1)
		endif(${_name_upper}_FOUND)
	endif (WITH_${_name_upper})

	if (NOT HAVE_${_name_upper})
		set(${_name_upper}_FOUND "")
		set(${_name_upper}_INCLUDE_DIRS "")
		set(${_name_upper}_INCLUDE_DIR "")
		set(${_name_upper}_INCLUDES "")
		set(${_name_upper}_LIBRARY "")
		set(${_name_upper}_LIBRARIES "")
	endif (NOT HAVE_${_name_upper})
