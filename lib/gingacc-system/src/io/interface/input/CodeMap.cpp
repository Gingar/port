...
namespace io {
	...
	int CodeMap::keyToValue ( util::key::type key ) {
		int result;
		switch (key) {
			case util::key::null: result = KEY_NULL; break;

			case util::key::number_0: result = KEY_0; break;
			case util::key::number_1: result = KEY_1; break;
			case util::key::number_2: result = KEY_2; break;
			case util::key::number_3: result = KEY_3; break;
			case util::key::number_4: result = KEY_4; break;
			case util::key::number_5: result = KEY_5; break;
			case util::key::number_6: result = KEY_6; break;
			case util::key::number_7: result = KEY_7; break;
			case util::key::number_8: result = KEY_8; break;
			case util::key::number_9: result = KEY_9; break;

			case util::key::small_a: result = KEY_SMALL_A; break;
			case util::key::small_b: result = KEY_SMALL_B; break;
			case util::key::small_c: result = KEY_SMALL_C; break;
			case util::key::small_d: result = KEY_SMALL_D; break;
			case util::key::small_e: result = KEY_SMALL_E; break;
			case util::key::small_f: result = KEY_SMALL_F; break;
			case util::key::small_g: result = KEY_SMALL_G; break;
			case util::key::small_h: result = KEY_SMALL_H; break;
			case util::key::small_i: result = KEY_SMALL_I; break;
			case util::key::small_j: result = KEY_SMALL_J; break;
			case util::key::small_k: result = KEY_SMALL_K; break;
			case util::key::small_l: result = KEY_SMALL_L; break;
			case util::key::small_m: result = KEY_SMALL_M; break;
			case util::key::small_n: result = KEY_SMALL_N; break;
			case util::key::small_o: result = KEY_SMALL_O; break;
			case util::key::small_p: result = KEY_SMALL_P; break;
			case util::key::small_q: result = KEY_SMALL_Q; break;
			case util::key::small_r: result = KEY_SMALL_R; break;
			case util::key::small_s: result = KEY_SMALL_S; break;
			case util::key::small_t: result = KEY_SMALL_T; break;
			case util::key::small_u: result = KEY_SMALL_U; break;
			case util::key::small_v: result = KEY_SMALL_V; break;
			case util::key::small_w: result = KEY_SMALL_W; break;
			case util::key::small_x: result = KEY_SMALL_X; break;
			case util::key::small_y: result = KEY_SMALL_Y; break;
			case util::key::small_z: result = KEY_SMALL_Z; break;

			case util::key::capital_a: result = KEY_CAPITAL_A; break;
			case util::key::capital_b: result = KEY_CAPITAL_B; break;
			case util::key::capital_c: result = KEY_CAPITAL_C; break;
			case util::key::capital_d: result = KEY_CAPITAL_D; break;
			case util::key::capital_e: result = KEY_CAPITAL_E; break;
			case util::key::capital_f: result = KEY_CAPITAL_F; break;
			case util::key::capital_g: result = KEY_CAPITAL_G; break;
			case util::key::capital_h: result = KEY_CAPITAL_H; break;
			case util::key::capital_i: result = KEY_CAPITAL_I; break;
			case util::key::capital_j: result = KEY_CAPITAL_J; break;
			case util::key::capital_k: result = KEY_CAPITAL_K; break;
			case util::key::capital_l: result = KEY_CAPITAL_L; break;
			case util::key::capital_m: result = KEY_CAPITAL_M; break;
			case util::key::capital_n: result = KEY_CAPITAL_N; break;
			case util::key::capital_o: result = KEY_CAPITAL_O; break;
			case util::key::capital_p: result = KEY_CAPITAL_P; break;
			case util::key::capital_q: result = KEY_CAPITAL_Q; break;
			case util::key::capital_r: result = KEY_CAPITAL_R; break;
			case util::key::capital_s: result = KEY_CAPITAL_S; break;
			case util::key::capital_t: result = KEY_CAPITAL_T; break;
			case util::key::capital_u: result = KEY_CAPITAL_U; break;
			case util::key::capital_v: result = KEY_CAPITAL_V; break;
			case util::key::capital_w: result = KEY_CAPITAL_W; break;
			case util::key::capital_x: result = KEY_CAPITAL_X; break;
			case util::key::capital_y: result = KEY_CAPITAL_Y; break;
			case util::key::capital_z: result = KEY_CAPITAL_Z; break;
				
			case util::key::page_down: result = KEY_PAGE_DOWN; break;
			case util::key::page_up:   result = KEY_PAGE_UP; break;

			case util::key::f1 : result = KEY_F1; break;
			case util::key::f2 : result = KEY_F2; break;
			case util::key::f3 : result = KEY_F3; break;
			case util::key::f4 : result = KEY_F4; break;
			case util::key::f5 : result = KEY_F5; break;
			case util::key::f6 : result = KEY_F6; break;
			case util::key::f7 : result = KEY_F7; break;
			case util::key::f8 : result = KEY_F8; break;
			case util::key::f9 : result = KEY_F9; break;
			case util::key::f10: result = KEY_F10; break;
			case util::key::f11: result = KEY_F11; break;
			case util::key::f12: result = KEY_F12; break;
				
			case util::key::plus_sign:  result = KEY_PLUS_SIGN; break;
			case util::key::minus_sign: result = KEY_MINUS_SIGN; break;
				
			case util::key::asterisk:    result = KEY_ASTERISK; break;
			case util::key::number_sign: result = KEY_NUMBER_SIGN; break;
				
			case util::key::period: result = KEY_PERIOD; break;
				
			case util::key::printscreen: result = KEY_PRINTSCREEN; break;
			case util::key::super:       result = KEY_SUPER; break;
			case util::key::menu:        result = KEY_MENU; break;
			case util::key::info:        result = KEY_INFO; break;
			case util::key::epg:         result = KEY_EPG; break;

			case util::key::cursor_down:  result = KEY_CURSOR_DOWN; break;
			case util::key::cursor_left:  result = KEY_CURSOR_LEFT; break;
			case util::key::cursor_right: result = KEY_CURSOR_RIGHT; break;
			case util::key::cursor_up:    result = KEY_CURSOR_UP; break;

			case util::key::channel_down: result = KEY_CHANNEL_DOWN; break;
			case util::key::channel_up: result = KEY_CHANNEL_UP; break;
				
			case util::key::volume_down: result = KEY_VOLUME_DOWN; break;
			case util::key::volume_up: result = KEY_VOLUME_UP; break;

			case util::key::enter: result = KEY_ENTER; break;
			case util::key::ok:    result = KEY_OK; break;				
				
			case util::key::red   : result = KEY_RED; break;
			case util::key::green : result = KEY_GREEN; break;
			case util::key::yellow: result = KEY_YELLOW; break;
			case util::key::blue  : result = KEY_BLUE; break;
				
			case util::key::backspace: result = KEY_BACKSPACE; break;
			case util::key::back  : result = KEY_BACK; break;
			case util::key::escape: result = KEY_ESCAPE; break;
			case util::key::exit  : result = KEY_EXIT; break;
				
			case util::key::power : result = KEY_POWER; break;
			case util::key::rewind: result = KEY_REWIND; break;
			case util::key::stop  : result = KEY_STOP; break;
			case util::key::eject : result = KEY_EJECT; break;
			case util::key::play  : result = KEY_PLAY; break;
			case util::key::record: result = KEY_RECORD; break;
			case util::key::pause : result = KEY_PAUSE; break;
				
			case util::key::greater_than_sign: result = KEY_GREATER_THAN_SIGN; break;
			case util::key::less_than_sign   : result = KEY_LESS_THAN_SIGN; break;
				
			case util::key::tap: result = KEY_TAP; break;
			default:
				result = KEY_NULL;
				break;
		}
